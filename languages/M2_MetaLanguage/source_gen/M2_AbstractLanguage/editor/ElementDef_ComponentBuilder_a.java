...
/*package*/ class ElementDef_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ElementDef_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_l8vc90_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_l8vc90_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.refClass$qDn_;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.refClass$qDn_);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.refClass$qDn_);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_0() {
      ...
      try {
        ...
        editorCell.setCellId("ED_property_name");
  ...
  private EditorCell createProperty_1() {
    ...
    try {
      ...
      editorCell.setDefaultText("<no name>");
      editorCell.setCellId("ED_property_name1");
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.PropertyAttribute$jT);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_l8vc90_d0");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_l8vc90_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  /*package*/ static class Inline_Builder1 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_2() {
      ...
      try {
        ...
        editorCell.setCellId("ED_property_date");
        editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
        setCellContext(editorCell);
        Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.PropertyAttribute$jT);
        Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_l8vc90_g0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  /*package*/ static class Inline_Builder2 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_3() {
      ...
      try {
        ...
        EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, true, false), myNode);
        editorCell.setDefaultText("<no name>");
        editorCell.setCellId("ED_property_name2");
        editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
        setCellContext(editorCell);
        Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.PropertyAttribute$jT);
        Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_l8vc90_i0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  /*package*/ static class Inline_Builder3 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_4() {
      ...
      try {
        ...
        EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, true, false), myNode);
        editorCell.setDefaultText("<no name>");
        editorCell.setCellId("ED_property_name3");
        editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
        setCellContext(editorCell);
        Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.PropertyAttribute$jT);
        Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
