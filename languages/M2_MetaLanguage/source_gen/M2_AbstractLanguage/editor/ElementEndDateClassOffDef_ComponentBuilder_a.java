...
/*package*/ class ElementEndDateClassOffDef_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ElementEndDateClassOffDef_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_obh5cw_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_obh5cw_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.setCellId("EEDCOD_property_name");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_obh5cw_d0");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_obh5cw_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_1() {
      ...
      try {
        ...
        editorCell.setCellId("EEDCOD_property_date");
        editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
        setCellContext(editorCell);
        Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.PropertyAttribute$jT);
        Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_obh5cw_g0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  /*package*/ static class Inline_Builder1 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_2() {
      ...
      try {
        ...
        EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, true, false), myNode);
        editorCell.setDefaultText("<no name>");
        editorCell.setCellId("EEDCOD_property_name1");
        editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
        setCellContext(editorCell);
        Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.PropertyAttribute$jT);
        Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_obh5cw_i0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  /*package*/ static class Inline_Builder2 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_3() {
      ...
      try {
        ...
        EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, true, false), myNode);
        editorCell.setDefaultText("<no name>");
        editorCell.setCellId("EEDCOD_property_name2");
        editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
        setCellContext(editorCell);
        Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.PropertyAttribute$jT);
        Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_5() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_obh5cw_k0");
    editorCell.setDefaultText("");
    return editorCell;
  }
