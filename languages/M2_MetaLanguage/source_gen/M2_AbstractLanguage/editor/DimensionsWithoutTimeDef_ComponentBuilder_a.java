...
/*package*/ class DimensionsWithoutTimeDef_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DimensionsWithoutTimeDef_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_t6y5ke_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_t6y5ke_b0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new levelsListHandler_t6y5ke_c0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("DWTD_refNodeList_levels");
    Style style = new StyleImpl();
  ...
  private static class levelsListHandler_t6y5ke_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public levelsListHandler_t6y5ke_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_t6y5ke_d0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new scenariosListHandler_t6y5ke_e0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("DWTD_refNodeList_scenarios");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    style.set(StyleAttributes.INDENT_LAYOUT_CHILDREN_NEWLINE, true);
  ...
  private static class scenariosListHandler_t6y5ke_e0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public scenariosListHandler_t6y5ke_e0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
