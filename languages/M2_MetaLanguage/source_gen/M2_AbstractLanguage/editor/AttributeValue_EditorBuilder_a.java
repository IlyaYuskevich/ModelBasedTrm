...
/*package*/ class AttributeValue_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.element$xZNa;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.element$xZNa);
    }
  ...
  /*package*/ static class Inline_Builder1 extends AbstractEditorBuilder {
    ...
    private EditorCell createCollection_1() {
      ...
      editorCell.setCellId("Collection_qq2e6z_a0c0");
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "]");
    editorCell.setCellId("Constant_qq2e6z_d0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_3() {
    final SReferenceLink referenceLink = LINKS.attribute$lZHv;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
        ...
        }, targetNode, LINKS.attribute$lZHv);
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
    ...
    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.attribute$lZHv);
    }
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfo(editorCell, referenceLink));
    Iterable<SNode> referenceAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.LinkAttribute$v_);
    Iterable<SNode> currentReferenceAttributes = Sequence.fromIterable(referenceAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_qq2e6z_f0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_3() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.value$N9sA;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  /*package*/ static class Inline_Builder4 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_4() {
      getCellFactory().pushCellContext();
      try {
        final SProperty property = PROPS.units$iG$x;
        getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
        EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, true, false), myNode);
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty value$N9sA = MetaAdapterFactory.getProperty(0x4b68402a1c7b472dL, 0x8c517b3c81719d43L, 0x7157f84cd378a96fL, 0x7157f84cd378a972L, "value");
    /*package*/ static final SProperty units$iG$x = MetaAdapterFactory.getProperty(0x4b68402a1c7b472dL, 0x8c517b3c81719d43L, 0x7157f84cd376c8d0L, 0x7157f84cd3ab903eL, "units");
  }
}
